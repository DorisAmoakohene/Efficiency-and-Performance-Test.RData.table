...
atime.list.4655 <- atime::atime_versions(
  ...
  setup={ 
    ...
    dt = data.table(ordered_id = seq_len(N),
                    unordered_id = sample(N),
                    value = replicate(n, data.table(val1 = sample(40L)), simplify = FALSE))
  },
  
  expr=data.table:::`[.data.table`(dt, , value[[1L]], by = unordered_id),
  "Before"="a8ec94484d2cc375d8295a94bacc5353576c238a",#https://github.com/Rdatatable/data.table/commit/a8ec94484d2cc375d8295a94bacc5353576c238a
  "Regression"="2dfd05f9fbddc7a6af97b8373e4bddc7262f7588", #https://github.com/Rdatatable/data.table/pull/4655/commits/2dfd05f9fbddc7a6af97b8373e4bddc7262f7588
